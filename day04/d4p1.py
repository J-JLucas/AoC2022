...
def main():
    ...
    for line in f.readlines():
        ...
        # determine if one range is fully encapuslated by the other
        if x1 == x2:        # if x1 = x2, then one of the sets is for sure encapulated by the other,doesn't matter which
            total+=1
